...
public interface AccountRepository extends JpaRepository<Account, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT * FROM accounts WHERE account_id = :accountId AND delete_at IS NULL")
	...
	@Query(nativeQuery = true, value = "SELECT user_name FROM accounts WHERE account_id = :accountId and user_name LIKE :userName AND delete_at IS NULL")
